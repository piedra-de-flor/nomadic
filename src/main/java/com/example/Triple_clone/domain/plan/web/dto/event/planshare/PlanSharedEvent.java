...
import com.example.Triple_clone.domain.plan.web.dto.PlanShareChangeData;
import com.example.Triple_clone.domain.plan.web.dto.event.PlanChangeEvent;
import lombok.Getter;

@Getter
public class PlanSharedEvent extends PlanChangeEvent {
    private final Member sharedMember;
    private final ShareRole role;

    public PlanSharedEvent(Object source, Plan plan, Member sharer, Member sharedMember, ShareRole role) {
        super(source, plan, sharer, ChangeType.SHARED, sharedMember.getId(), TargetType.MEMBER);
