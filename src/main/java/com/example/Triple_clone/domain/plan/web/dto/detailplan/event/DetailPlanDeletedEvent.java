...
@Getter
public class DetailPlanDeletedEvent extends PlanChangeEvent {
    private final DetailPlan detailPlan;

    public DetailPlanDeletedEvent(Object source, Plan plan, Member changedBy, DetailPlan detailPlan) {
        super(source, plan, changedBy, ChangeType.DELETED, detailPlan.getId(), TargetType.DETAIL_PLAN);
