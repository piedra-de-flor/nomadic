...
public class ReportService {
    ...
    @Transactional
    public void reportReview(Long commentId, Long reporterId, ReportingReason reason, String detail) {
        if (reportRepository.existsByReviewIdAndReporterId(commentId, reporterId)) {
