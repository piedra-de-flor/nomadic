...
public class DetailPlanDtoTest {
    ...
    void 세부_계획_생성_DTO_유효성_성공() {
        DetailPlanDto dto = new DetailPlanDto(1L, new Location(1D,1D, "Test Location"), new Date(), "test", 0L);
    ...
    void 세부_계획_생성_DTO_유효성_실패_위치_null() {
        DetailPlanDto dto = new DetailPlanDto(1L, null, new Date(), "test", 0L);
    ...
    void 세부_계획_생성_DTO_유효성_실패_날짜_null() {
        DetailPlanDto dto = new DetailPlanDto(1L, new Location(1D,1D, "Test Location"), null, "test", 0L);
