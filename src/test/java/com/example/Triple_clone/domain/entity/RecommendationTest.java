...
public class RecommendationTest {
    @Test
    void 장소_업데이트_테스트() {
        Recommendation recommendation = new Recommendation("test", "test", "test", "test", "test");
        recommendation.update("test0", "test0", "test0", "test0", "test0");

        assertThat(recommendation.getTitle()).isEqualTo("test0");
        assertThat(recommendation.getLocation()).isEqualTo("test0");
    ...
    void 장소_업데이트_실패_테스트_제목_null() {
        ...
        Assertions.assertThrows(NullPointerException.class,
                () -> recommendation.update(null, "test0", "test0", "test0", "test0"));
    }
